  ...
  return (
    <div className='border p-6 shadow rounded'>
      ...
      <div className='mt-4 flex gap-4 text-xm'>
        <button className='bg-blue-500 text-white px-4 py-2 rounded' onClick={()=>{navigate(`/apply-job/${job._id}`) ;scrollTo(0,0)}}>Apply Now</button>
        <button className='text-gray-400 border border-gray-50 rounded px-4 py-2' onClick={()=>{navigate(`/apply-job/${job._id}`) ;scrollTo(0,0)}}>Learn More</button>
